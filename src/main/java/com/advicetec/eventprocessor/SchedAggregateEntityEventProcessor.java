...
public class SchedAggregateEntityEventProcessor implements Processor
{
	...
	public List<DelayEvent> process() throws SQLException 
	{
        ...
        logger.info("process - aggregateMethod:" + aggregateMethod);
		...
		if (entityFacade != null){
	        ...
	        if(aggregateMethodIns == null){
		        logger.error("Aggregate Method ["+aggregateMethod+"] don't exists.");
	        }else{
		        logger.info("SchedAggregate :" + aggregateMethod+" : ["+aggregateMethodIns.getMethod()+"]["+aggregateMethodIns.getAttribute()+"]["+aggregateMethodIns.getType()+"]");
		...
		logger.info("end process - aggregateMethod:" + aggregateMethod);
